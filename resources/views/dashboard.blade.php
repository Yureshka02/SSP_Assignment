<x-app-layout>
    ...
    <nav id="navbar" class="navbar fixed z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 transition-transform duration-300">
                        ...
                        <div class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800 xl:mb-0">
                            ...
                            <ol class="relative border-l border-gray-200 dark:border-gray-700">
                                <li class="mb-10 ml-4">
                                    ...
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">50 new employees recruitment</h3>
                                ...
                                <li class="mb-10 ml-4">
                                    ...
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Introduced 7 new facilities</h3>
                                ...
                                <li class="mb-10 ml-4">
                                    ...
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Opened a new detailing centre</h3>
