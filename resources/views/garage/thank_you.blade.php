<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Appointment Confirmed') }} #{{ $order->id }}
        </h2>
    </x-slot>
    ...
    <main class="bg-white px-4 pb-24 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-3xl">
            <div class="max-w-xl">
                ...
                <p class="mt-2 text-base text-gray-500">Your Appointment #{{ $order->id }} has shipped and will be with you
                    soon.</p>
                ...
                <div class="sm:ml-40 sm:pl-6">
                    ...
                    <dl class="space-y-6 border-t border-gray-200 pt-10 text-sm">
                        <div class="flex justify-between">
                            ...
                            <dd class="text-gray-700">${{ $order->garage->total }}</dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="font-medium text-gray-900">Total</dt>
                            <dd class="text-gray-900">${{ $order->garage->total }}</dd>
                        </div>
                    </dl>
                </div>
            </section>
