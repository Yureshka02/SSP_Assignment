...
<div x-data="{ open: @entangle('show_cart') }">
    @if($cart)
        <div class="fixed bottom-3 right-3 bg-gray-800 rounded-full shadow p-2">
            <a href="#" class="group -m-2 flex items-center p-2" x-on:click="open = true">
                <svg class="h-10 flex-shrink-0 text-teal-400 group-hover:text-teal-500" fill="none" viewBox="0 0 24 24"
                ...
                <span
                    class="ml-2 text-sm font-medium text-teal-300 group-hover:text-teal-400 absolute top-0 right-0 bg-teal-600 w-1/2 rounded-full text-center p-1 bg-opacity-75">
                {{ $cart->products->count() }}
                </span>
                            ...
                            <div class="flex h-full flex-col overflow-y-scroll bg-gray-800 shadow-xl">
                                <div class="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                                    <div class="flex items-start justify-between">
                                        <h2 class="text-lg font-medium text-teal-300" id="slide-over-title">Shopping cart</h2>
                                        <div class="ml-3 flex h-7 items-center">
                                            <button type="button"
                                                    x-on:click="open = false"
                                                    class="relative -m-2 p-2 text-teal-400 hover:text-teal-500">
                                            ...
                                            <ul role="list" class="-my-6 divide-y divide-gray-600">
                                                @if($cart->products->count())
                                                    @foreach($cart->products as $product)
                                                        <li class="flex py-6">
                                                            <div
                                                                class="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-600">
                                                                <img
                                                            ...
                                                            <div class="ml-4 flex flex-1 flex-col">
                                                                <div>
                                                                    <div
                                                                        class="flex justify-between text-base font-medium text-teal-300">
                                                                        <h3>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="flex">
                                                                        <button type="button"
                                                                                ...
                                                                                class="font-medium text-teal-400 hover:text-teal-500">
                                                                            Remove
                                                                        </button>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="border-t border-gray-600 px-4 py-6 sm:px-6">
                                    <div class="flex justify-between text-base font-medium text-teal-300">
                                        <p>Subtotal</p>
                                        <p>${{ $cart->total }}</p>
                                    </div>
