                    ...
                    <div class="">
                        ...
                        <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                            <div>
                                ...
                                <div class="mt-1">
                                    <input type="text" id="first-name" name="first_name" autocomplete="given-name" class="block w-full rounded-md border-gray-700 bg-gray-800 text-teal-100 shadow-sm focus:border-teal-500 focus:ring-teal-500 sm:text-sm">
                                </div>
                            </div>
                                    ...
                                    <div class="ml-6 flex flex-1 flex-col">
                                        <div class="flex">
                                            <div class="min-w-0 flex-1">
                                                <h4 class="text-sm">
                                                    <a href="#" class="font-medium text-teal-200 hover:text-teal-100">{{ $product->name }}</a>
                                                </h4>
                                                <p class="mt-1 text-sm text-teal-300">{{ $product->description }}</p>
                                            </div>

                                            <div class="ml-4 flow-root flex-shrink-0">
                                                <button type="button" class="-m-2.5 flex items-center justify-center bg-gray-800 p-2.5 text-teal-400 hover:text-teal-300">
                                        ...
                                        <div class="flex flex-1 items-end justify-between pt-2">
                                            <p class="mt-1 text-sm font-medium text-teal-100">$ {{ $product->pivot->total }}</p>
                                        </div>
                                    </div>
                                </li>
                            @endforeach
